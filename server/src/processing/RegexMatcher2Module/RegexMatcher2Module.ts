 ...
 */
 ...
 export class RegexMatcher2Module extends Module<Options> {
   public static moduleName = 'regex-matcher2';
   ...
   public findWordsAndAddMetadata(paragraph: Paragraph, result: any, query: any, pageNumber: any): any {
